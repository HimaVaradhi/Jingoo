...
public class CCUnderstandRewardPointActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ccunderstand_reward_point);
        ...
        mBtnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (r1.isChecked()){
                    product_list = "Reward points are not updating on stock submit.";
                }else if (r2.isChecked()){
                    product_list = "My displayed rank is incorrect.";
                }else if (r3.isChecked()){
                    product_list = "My total earned points are incorrect";
                }else {
                    product_list = mEdtIssue.getText().toString();
                }

                if (product_list.equals("")){
                    Toast.makeText(CCUnderstandRewardPointActivity.this , "Please select atleast one point" , Toast.LENGTH_LONG).show();
                }else {

                    appUtils.products_ccare("Understanding Rewards Points" , "" , product_list);
