...
public class SalesValuationReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sales_valuation_report);
        ...
        mTxtHeaderName.setText(getResources().getString(R.string.Sales_Valuation_Report));
        mTxtHome.setText(getResources().getString(R.string.Sales_Valuation_Report));
    ...
    private void valuation_report() {

        appUtils.showProgressBarLoading();

        mDailySalesList.clear();

        String REGISTER_URL = SalesValuationReportActivity.this.getResources().getString(R.string.base_url) + "v1/index.php/appshopboth/valuation_report";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (success.equals("1")){
                            ...
                            JSONArray jsonArray = jsonObject.optJSONArray("row_array_chart");

                            for (int i = 0 ; i < jsonArray.length() ; i++){

                                JSONObject jObject = jsonArray.optJSONObject(i);

                                String selling_qty = jObject.optString("selling_price");
                        ...
                        for (int j = 0 ; j < mDailySalesList.size() ; j++){
                            ...
                            xVals.add(mDailySalesList.get(j).getSelling_qty() + " " + mDailySalesList.get(j).getCategory_name());
                            }
